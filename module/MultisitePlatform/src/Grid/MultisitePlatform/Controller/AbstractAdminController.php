...
use Zork\Mvc\Controller\AbstractInjectorController;

/**
 * Grid\MultisitePlatform\Controller\AbstractAdminController
 *
...
abstract class AbstractAdminController extends AbstractInjectorController
{
     ...
     * @var string
     */
    const NOT_ALLOWED_REDIRECT_URL      = 'Grid\MultisitePlatform\Admin\NotAllowed';
    ...
    public function onDispatch( MvcEvent $event )
    {
        ...
        {
            $layout->setMiddleLayout( 'layout/middle/multisite-admin', array(
